...
public static class AeroGlass
{
    ...
    /// <summary>
    /// Windows 11 22H2+ real acrylic system backdrop. Returns false on older
    /// builds so callers fall back to SetWindowCompositionAttribute.
    /// </summary>
    ...
    /// <summary>Ask Windows 11 DWM to round the real window surface (clips the blur too).</summary>
